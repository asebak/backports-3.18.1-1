...
__attribute__((section("__versions"))) = {
	...
	{ 0xbdd1508e, "backport_eth_commit_mac_addr_change" },
	{ 0x926bac9b, "backport_eth_prepare_mac_addr_change" },
...
MODULE_INFO(srcversion, "244F5A0185D731869BAFCDC");
